...
class TestExpectedErrorMiddleware(unittest.TestCase):
    ...
    def test_process_exception_no_expected_errors(self, mock_logger, mock_set_custom_attribute):
        ExpectedErrorMiddleware(get_response=lambda request: None).process_exception(self.mock_request, self.mock_exception)
    ...
    def test_process_exception_called_multiple_times(self, use_same_exception, mock_set_custom_attribute):
        ...
        ExpectedErrorMiddleware(get_response=lambda request: None).process_exception(self.mock_request, mock_first_exception)
        ExpectedErrorMiddleware(get_response=lambda request: None).process_exception(self.mock_request, mock_second_exception)
    ...
    def test_process_exception_with_plain_exception(self, mock_set_custom_attribute):
        ...
        ExpectedErrorMiddleware(get_response=lambda request: None).process_exception(self.mock_request, mock_exception)
